...
import {
  ...
  usePostsDataQuery,
  useUsersDataQuery,
} from "../../store/slices/queries";

export default function DashboardComp() {
  const { data: postData } = usePostsDataQuery();
  const { data: usersData, error } = useUsersDataQuery();
  const { data: commentsData } = useCommentsDataQuery();
